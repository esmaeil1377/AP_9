...
public class BazaarView {
    ...
    public void AddBackgroung(Stage primaryStage) {
    ...
    public void AddButtton(Stage primaryStage) {
        ...
        buttonOkImageView.setFitWidth(160);
        buttonOkImageView.relocate(1190, 460);
        ...
        buttonOkImageView.setOnMouseEntered(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                buttonOkImageView.setFitWidth(170);
                buttonOkImageView.relocate(1190 - 5, 460 - 5);
            }
        });
    ...
    private void UpdateMoneyLabelForSellAndCapacityBar() throws UnknownObjectException, MissionNotLoaded {
        ...
        LoadDegreeForCapacity((int)(((float)getCapacityNeeded()/(float)capacityOfTruck)*10));
