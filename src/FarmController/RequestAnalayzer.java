...
public class RequestAnalayzer {
    ...
    public static void RequestAnalayzer(String requestString) throws UnknownObjectException, MissionNotLoaded, FullWareHouse, BucketIsEmptyException, NotEnoughMoney, WellIsNotEmpty, MaxLevelExceeded, MissionIsFinished {
