...
//            try {
//                ArrayList<String> groupMassage=GameView.getGameView().getHostAndGuestView().getMassagedidntsent();
//                if (groupMassage.size() != 0) {
//                    SendMassageForGuest(formatter, groupMassage);
//                    GameView.getGameView().getHostAndGuestView().setMassagedidntsent(new ArrayList<>());
//                }
//            }catch (Exception e){
//                e.printStackTrace();
//            }
